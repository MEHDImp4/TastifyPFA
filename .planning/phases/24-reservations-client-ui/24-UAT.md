...
updated: 2026-05-06T13:54:56.2934454+01:00
---

## Current Test

number: 1
name: Reservation Details Step
expected: |
  Open the portail client reservation flow at `/reservations/new`.
  You should see the first wizard step with fields for date, start time, end time, and party size.
  After entering a valid slot and party size, continuing should move you to the table-selection step.
