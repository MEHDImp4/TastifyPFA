...
The backend now includes a checklist domain so management can define opening/closing procedures and staff can execute daily checklist instances through the API.
...
- `apps.checklists` — checklist templates, ordered tasks, daily executions, and per-item completion responses.
