    ...
    def seed_menu(self):
        SEED_DATA = [
            ...
            },
            {
                ...
                'plats': [
                    {'nom': 'Cornes de Gazelle', 'description': "Gâteaux sablés à la pâte d'amande (3 pièces)", 'prix': '8.00', 'temps_preparation': 5, 'image': 'plats/cornes_gazelle.png'},
                    {'nom': 'Chebakia', 'description': 'Gâteaux au miel, sésame et anis (assiette)', 'prix': '7.50', 'temps_preparation': 5, 'image': 'plats/chebakia.png'},
                    {'nom': 'Briouates au Miel', 'description': 'Feuilletés aux amandes et miel (3 pièces)', 'prix': '8.50', 'temps_preparation': 8, 'image': 'plats/briouates_miel.png'},
                    {'nom': "Salade d'Oranges", 'description': "Oranges à la cannelle et eau de fleur d'oranger", 'prix': '7.50', 'temps_preparation': 10, 'image': 'plats/salade_oranges.png'},
                    {'nom': 'Msemen au Miel', 'description': 'Crêpes feuilletées servies avec du miel', 'prix': '7.00', 'temps_preparation': 10, 'image': 'plats/msemen_miel.png'},
                    {'nom': 'Ghriba aux Amandes', 'description': "Biscuits fondants à la poudre d'amandes et sucre glace", 'prix': '7.50', 'temps_preparation': 5, 'image': 'plats/ghriba_amandes.png'},
                    {'nom': 'Ghriba aux Noix', 'description': "Biscuits croquants à la poudre de noix et sucre glace", 'prix': '7.50', 'temps_preparation': 5, 'image': 'plats/ghriba_noix.png'},
                ],
            },
            {
                'categorie': {
                ...
                'plats': [
                    {'nom': 'Thé à la Menthe', 'description': 'Thé vert traditionnel à la menthe fraîche', 'prix': '4.00', 'temps_preparation': 5, 'image': 'plats/the_menthe.png'},
                    {'nom': "Jus d'Orange Frais", 'description': 'Oranges pressées à la demande', 'prix': '5.50', 'temps_preparation': 5, 'image': 'plats/jus_orange.png'},
                    {'nom': 'Lben', 'description': 'Lait fermenté traditionnel frais', 'prix': '4.00', 'temps_preparation': 2, 'image': 'plats/lben.png'},
                    {'nom': 'Café Noir/Cassé', 'description': 'Café fraîchement moulu', 'prix': '3.50', 'temps_preparation': 5, 'image': 'plats/cafe.png'},
                    {'nom': 'Café au Lait', 'description': 'Café mélangé avec du lait chaud', 'prix': '4.50', 'temps_preparation': 5, 'image': 'plats/cafe_lait.png'},
                    {'nom': 'Café à la Menthe', 'description': 'Café infusé avec de la menthe fraîche', 'prix': '5.00', 'temps_preparation': 5, 'image': 'plats/cafe_menthe.png'},
                    {'nom': 'Café aux Épices', 'description': 'Café aromatisé avec de la cannelle et du gingembre', 'prix': '5.00', 'temps_preparation': 5, 'image': 'plats/cafe_epices.png'},
                ],
            },
        ]
