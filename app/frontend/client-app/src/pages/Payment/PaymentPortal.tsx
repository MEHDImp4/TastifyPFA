  ...
  if (isSuccess) return (
    <div className="min-h-[100dvh] flex flex-col items-center justify-center bg-background p-6 text-center font-body">
        <div className="w-full max-w-xl atelier-card p-6 sm:p-10 md:p-12 relative overflow-hidden">
            ...
            <p className="text-base sm:text-lg text-on-surface-variant uppercase tracking-wider sm:tracking-widest leading-relaxed mb-10 md:mb-12">Merci de votre visite chez {brandName}. Votre session a été réglée avec succès.</p>
    ...
    <div className="min-h-[100dvh] bg-background font-body selection:bg-on-background/10 flex flex-col items-center py-8 md:py-24 px-4 sm:px-6 overflow-x-hidden">
        <main className="w-full max-w-2xl flex flex-col gap-8 md:gap-12">
            ...
            <div className="text-center space-y-4">
                ...
                <p className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">Inclut les frais de service automatisés</p>
            </div>
            ...
            <div className="atelier-card p-6 sm:p-10 flex flex-col items-center gap-8 shadow-sm">
                ...
                <p className="text-[14px] text-on-surface-variant max-w-xs text-center uppercase tracking-tight">Scannez pour une autorisation biométrique sécurisée via Apple Pay ou Google Pay</p>
