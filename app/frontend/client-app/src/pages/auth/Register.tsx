  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#FDF8F4] text-[#1C140E] overflow-x-hidden font-['Bodoni_Moda'] pt-12 pb-24 px-6 md:px-12">
      ...
      >
        ...
        >
          {/* Cinematic Side Block (Left on Register) */}
          <motion.div 
            variants={bentoItemVariants}
            className="md:col-span-5 lg:col-span-4 space-y-8 order-2 md:order-1"
          >
            {/* Image Card */}
            ...
            <div className="bg-[#1C140E] text-[#FDF8F4] p-10 rounded-[3rem] relative overflow-hidden group">
              <div className="relative z-10">
                <h3 className="font-['Libre_Caslon_Text'] text-3xl mb-4 italic">Rejoignez l'Élite.</h3>
                <p className="text-sm text-[#FDF8F4]/60 font-medium leading-relaxed mb-8">
                  Créez votre archive membre pour bénéficier d'une expérience gastronomique augmentée par l'intelligence artificielle.
                </p>
          ...
          {/* Main Register Form Card (Right on Register) */}
          <motion.div 
            variants={bentoItemVariants}
            className="md:col-span-7 lg:col-span-8 bg-white rounded-[3rem] border border-[#1C140E]/5 p-8 md:p-16 flex flex-col justify-center relative overflow-hidden order-1 md:order-2"
          >
            <div className="max-w-md w-full mx-auto relative z-10">
              ...
              <h1 className="font-['Libre_Caslon_Text'] text-5xl md:text-7xl leading-[0.9] tracking-tighter mb-12">
                Commencez <br/><span className="italic text-[#D1854E]">l'Aventure.</span>
              </h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="space-y-6">
                  ...
                  <div className="group relative">
                    ...
                    <div className="relative">
                      <UserPlus className="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 text-[#1C140E]/30 group-focus-within:text-[#D1854E] transition-colors" />
                      <input
                        type="text"
                        required
                        value={username}
                        onChange={(e) => setUsername(e.target.value)}
                        className="w-full pl-16 pr-8 py-5 bg-[#FDF8F4] border border-[#1C140E]/5 rounded-[2rem] font-['Bodoni_Moda'] font-bold text-lg focus:border-[#D1854E] focus:bg-white outline-none transition-all shadow-sm"
                  ...
                  {/* Communication Link */}
                  <div className="group relative">
                    <label className="font-['Bricolage_Grotesque'] text-[10px] font-black uppercase tracking-[0.25em] text-[#D1854E] ml-4 mb-2 block">Lien de Communication</label>
                    <div className="relative">
                      <Mail className="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 text-[#1C140E]/30 group-focus-within:text-[#D1854E] transition-colors" />
                      <input
                        type="email"
                        required
                        value={email}
                  ...
                  {/* Pass-phrase */}
                  <div className="group relative">
                    <label className="font-['Bricolage_Grotesque'] text-[10px] font-black uppercase tracking-[0.25em] text-[#D1854E] ml-4 mb-2 block">Mot de Passe</label>
                    <div className="relative">
                ...
                >
                  {isLoading ? (
                    ...
                    <>
                      <span>INITIALISER MON COMPTE</span>
              ...
              <div className="mt-16 pt-10 border-t border-[#1C140E]/5 text-center md:text-left">
                <p className="text-sm font-bold text-[#1C140E]/60">
                  ...
                  <Link to="/login" className="font-['Bricolage_Grotesque'] font-black uppercase text-xs tracking-widest text-[#D1854E] hover:underline ml-2">
                    Se Connecter
                  </Link>
                </p>
              </div>
