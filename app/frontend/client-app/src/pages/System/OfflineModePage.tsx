    ...
    <div className="min-h-[100dvh] flex flex-col items-center justify-center bg-background font-body selection:bg-primary/20 p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="space-y-6">
           <h1 className="font-serif text-3xl md:text-5xl font-black text-on-surface uppercase italic tracking-tighter m-0">Connection Lost</h1>
           <p className="font-body text-lg md:text-xl text-on-surface-variant uppercase tracking-widest leading-relaxed max-w-md mx-auto opacity-60">
              Your menu and profile preferences are securely cached. Live synchronization is temporarily paused until we re-establish a connection.
           </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-8">
           ...
           <div className={`flex items-center gap-3 transition-opacity duration-500 ${isRetrying ? 'opacity-100' : 'opacity-0'}`}>
              ...
              <span className="font-sans text-[9px] font-black text-on-surface-variant uppercase tracking-widest">Attempting to reconnect...</span>
           </div>
        </div>
        ...
        <div className="pt-12 border-t border-outline-variant/10 w-full max-w-sm flex items-center justify-center gap-8 opacity-20">
           <div className="flex items-center gap-2">
              ...
              <span className="font-sans text-[8px] font-black uppercase tracking-widest">Local Shield Active</span>
           </div>
           <div className="flex items-center gap-2">
              <Database className="w-3 h-3" />
              <span className="font-sans text-[8px] font-black uppercase tracking-widest">Cache Validated</span>
           </div>
        </div>
      </motion.div>
    </div>
