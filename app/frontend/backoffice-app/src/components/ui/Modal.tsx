  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      <div 
        ...
        onClick={onClose}
      />
      <div className="relative w-full max-w-lg bg-surface rounded-[2rem] border border-outline-variant/30 shadow-2xl overflow-hidden animate-in zoom-in-95 fade-in duration-200">
