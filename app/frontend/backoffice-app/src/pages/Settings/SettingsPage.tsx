      ...
      <form onSubmit={handleSave} className="space-y-8">
        ...
        <motion.div className="double-bezel p-8 md:p-10 bg-white" variants={fadeInUp}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
            <div className="space-y-4">
              <p className="text-xs font-bold text-on-surface-variant uppercase tracking-widest opacity-60">Logo Restaurant</p>
              <div className="relative group w-full aspect-square rounded-3xl overflow-hidden bg-surface-container-low border-2 border-dashed border-surface-container-high flex flex-col items-center justify-center transition-all hover:border-primary/40">
                {logoPreview ? (
                  <>
                    <img src={logoPreview} alt="Logo Preview" className="w-full h-full object-contain p-4" />
                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                        <label className="cursor-pointer bg-white text-on-surface px-4 py-2 rounded-xl text-xs font-bold shadow-xl">
                            Modifier le logo
                  ...
                  <label className="cursor-pointer flex flex-col items-center gap-3 w-full h-full justify-center">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">Upload Logo</span>
                    <input type="file" className="hidden" onChange={handleLogoChange} accept="image/*" />
                  </label>
                )}
              </div>
            ...
            <div className="md:col-span-2 space-y-6">
              <div className="space-y-2">
                <label className="text-xs font-bold text-on-surface-variant uppercase tracking-widest opacity-60 px-1">Nom de l'établissement</label>
                <div className="relative">
                  <input 
                    ...
                    className="w-full bg-surface-container-low border-none rounded-2xl px-5 py-4 font-sans font-semibold text-on-surface focus:ring-2 focus:ring-primary/20 transition-all"
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  value={config.devise}
                  onChange={handleInputChange}
                  className="w-full bg-surface-container-low border-none rounded-2xl px-5 py-4 font-sans font-semibold text-on-surface focus:ring-2 focus:ring-primary/20 transition-all max-w-[100px]"
                  placeholder="DH"
                />
              </div>
            </div>
        ...
        <motion.div className="double-bezel p-8 md:p-10 bg-white" variants={fadeInUp}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-2">
              <label className="text-xs font-bold text-on-surface-variant uppercase tracking-widest opacity-60 px-1">Email de contact</label>
              <div className="relative flex items-center">
                <Mail className="absolute left-5 w-4 h-4 text-on-surface-variant opacity-40" />
                <input 
                  type="email" 
                  name="email"
                  value={config.email || ''}
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-on-surface-variant uppercase tracking-widest opacity-60 px-1">Téléphone</label>
              <div className="relative flex items-center">
                <Phone className="absolute left-5 w-4 h-4 text-on-surface-variant opacity-40" />
                <input 
                  type="text" 
                  name="telephone"
            ...
            <div className="md:col-span-2 space-y-2">
              <label className="text-xs font-bold text-on-surface-variant uppercase tracking-widest opacity-60 px-1">Adresse physique</label>
              <div className="relative flex items-start">
                <MapPin className="absolute left-5 top-5 w-4 h-4 text-on-surface-variant opacity-40" />
                <textarea 
                  name="adresse"
        ...
        >
          <button 
            type="submit" 
            disabled={isSaving}
            className="flex items-center gap-3 px-10 py-5 bg-primary text-white rounded-2xl font-bold shadow-xl shadow-primary/20 hover:scale-105 transition-all active:scale-95 disabled:opacity-50 disabled:scale-100"
          >
            {isSaving ? (
