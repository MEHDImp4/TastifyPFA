        ...
        {tickets.map((ticket) => (
          <div key={ticket.id} className="double-bezel flex flex-col overflow-hidden animate-in slide-in-from-bottom-4 duration-500 hover:scale-[1.01] transition-transform">
            ...
            <div className={`p-6 flex items-center justify-between border-b border-surface-container-high ${ticket.type === 'EMPORTER' ? 'bg-secondary-container/30' : 'bg-primary-container/10'}`}>
              ...
              <div className="glass px-4 py-2 rounded-none text-xs font-bold text-on-surface uppercase tracking-widest font-mono border border-primary/10">
                #{ticket.id}
              </div>
            </div>
                ...
                <div key={item.id} className="relative flex flex-col gap-3 p-5 bg-surface-container-low rounded-none border border-surface-container-high transition-all">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      {item.notes && (
                        <div className="mt-2 text-xs font-bold text-secondary bg-secondary-container/50 px-3 py-1.5 rounded-none italic font-sans flex items-center gap-2">
                    ...
                    <div className="flex flex-col items-end gap-2">
                      <span className={`
                        px-2 py-1 rounded-none text-[10px] font-bold uppercase tracking-widest font-mono font-sans
            ...
            <div className="p-5 bg-surface-container-low/50 border-t border-surface-container-high flex items-center justify-between">
                <div className="flex items-center gap-2 text-xs font-bold text-on-surface-variant uppercase tracking-widest font-mono opacity-60 font-sans">
                ...
                {ticket.lignes.every(l => l.statut === 'PRET') && (
                    <div className="flex items-center gap-2 text-primary text-xs font-bold uppercase tracking-widest font-mono animate-pulse font-sans">
