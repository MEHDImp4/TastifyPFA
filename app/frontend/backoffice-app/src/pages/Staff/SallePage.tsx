    ...
    <div className="max-w-[1600px] mx-auto h-[calc(100dvh-10rem)] flex flex-col animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-3 shrink-0">
        ...
        <div className="flex flex-wrap items-center gap-2">
               ...
               <div className="flex items-center gap-3">
                 {isEditMode && (
                     ...
                     <button
                        ...
                        className="flex items-center gap-2 px-4 py-3 rounded-none font-bold transition-all duration-300 active:scale-95 bg-surface-container-high text-on-surface hover:bg-surface-container-highest"
                     >
                 ...
                 <button 
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-none font-bold transition-all duration-300 active:scale-95 ${isEditMode ? 'bg-primary text-white shadow-[2px_2px_0px_rgba(15,23,42,0.1)] shadow-primary/20' : 'bg-white border border-surface-container-high text-on-surface hover:bg-surface-container-low'}`}
                 >
           ...
           <div className="flex items-center gap-3 px-8 py-2 glass rounded-none border border-surface-container-high shadow-[2px_2px_0px_rgba(15,23,42,0.1)]">
      ...
      {(selectedTableForEdit || isAddingTable) && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            <div className="bg-white rounded-none p-5 max-w-md w-full shadow-[2px_2px_0px_rgba(15,23,42,0.1)] animate-in zoom-in-95 duration-200">
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full px-4 py-3 rounded-none bg-surface-container-low border-2 border-transparent focus:border-primary focus:bg-white transition-all outline-none font-sans text-sm font-bold"
                            placeholder="e.g. 12"
                        />
                    </div>
                    <div>
