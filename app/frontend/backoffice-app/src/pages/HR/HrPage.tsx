      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-2">
            <button 
                ...
                className="flex items-center gap-2 px-3 py-2.5 bg-surface-container border border-outline-variant/30 rounded-none font-bold transition-transform hover:border-primary active:scale-95"
                style={{ color: '#301400' }}
            >
                <FileText className="w-4 h-4"  strokeWidth={1.5}/>
                Exporter la liste (PDF)
            </button>
            <button className="flex items-center gap-2 px-3 py-2.5 bg-primary text-on-primary rounded-none font-bold transition-transform hover:brightness-110 active:scale-95 shadow-[2px_2px_0px_rgba(15,23,42,0.1)] shadow-primary/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {employes.map((emp) => (
            <div key={emp.id} className="p-4 tonal-card group hover:border-primary/30 transition-all">
              <div className="flex items-start justify-between mb-6">
                <div className="w-10 h-10 rounded-none bg-primary-container/20 flex items-center justify-center text-primary">
          ...
          {employes.length === 0 && (
            <div className="col-span-full py-20 flex flex-col items-center justify-center" style={{ color: '#53443a', opacity: 0.5 }}>
                <Users className="w-16 h-10 mb-4"  strokeWidth={1.5}/>
