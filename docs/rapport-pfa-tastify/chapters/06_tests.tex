...
\begin{enumerate}
  ...
  \item commentaire arabe routé vers \code{moussaKam/MARBERT-sentiment} ;
  \item indisponibilité Hugging Face entraînant l'utilisation de \code{mots-cles-simple} ;
...
\begin{itemize}
  ...
  \item certaines informations administratives de la page de garde restent à confirmer.
\end{itemize}
