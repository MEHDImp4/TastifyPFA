...
\subsection{Matrices de confusion et analyse}
La confrontation des prédictions à la vérité terrain permet de dresser les matrices de confusion pour les deux approches (Table~\ref{tab:confusion-local} et Table~\ref{tab:confusion-bert}).

\begin{table}[H]
\centering
\caption{Matrice de confusion -- Modèle local par mots-clés}
\label{tab:confusion-local}
\begin{tabular}{c c|ccc}
\multicolumn{2}{c}{} & \multicolumn{3}{c}{\textbf{Prédiction Local}} \\
\multicolumn{2}{c}{} & POSITIF & NEUTRE & NEGATIF \\
\hline
\multirow{3}{*}{\textbf{Vrai}} & POSITIF & 3 & 2 & 0 \\
& NEUTRE & 1 & 4 & 0 \\
& NEGATIF & 0 & 3 & 2 \\
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Matrice de confusion -- Modèle principal BERT / MARBERT}
\label{tab:confusion-bert}
\begin{tabular}{c c|ccc}
\multicolumn{2}{c}{} & \multicolumn{3}{c}{\textbf{Prédiction BERT}} \\
\multicolumn{2}{c}{} & POSITIF & NEUTRE & NEGATIF \\
\hline
\multirow{3}{*}{\textbf{Vrai}} & POSITIF & 5 & 0 & 0 \\
& NEUTRE & 0 & 4 & 1 \\
& NEGATIF & 0 & 0 & 5 \\
\end{tabular}
\end{table}
...
\subsection{Calcul des métriques de performance}
