...
La figure~\ref{fig:capture-test-pytest} confirme l'exécution complète de la suite backend, avec les tests Django et API validés dans l'environnement local.
...
La figure~\ref{fig:capture-test-playwright} documente la validation end-to-end du portail client et isole l'unique échec comme un problème de sélecteur de test.
