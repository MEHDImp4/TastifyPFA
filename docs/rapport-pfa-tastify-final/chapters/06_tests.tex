...
CI & \pathcode{.github/workflows/backoffice-ci.yml} et résultats locaux ci-dessus & Workflow disponible, validation locale exécutée & Le workflow CI automatise les mêmes familles de contrôles ; la preuve intégrée montre la configuration et les résultats locaux équivalents. \\
\bottomrule
\end{tabularx}
\end{table}
