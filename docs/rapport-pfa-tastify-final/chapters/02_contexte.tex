...
\midrule
Lightspeed Restaurant \cite{lightspeed} & Caisse, menu, commandes, reporting. & Coût récurrent, dépendance à une offre commerciale. & Confirme l'intérêt d'une solution intégrée. \\
Toast POS \cite{toast} & Orientation restaurant, commande et paiement. & Disponibilité et adaptation au marché local variables. & Montre l'importance du lien salle-cuisine. \\
Revel Systems \cite{revel} & Couverture ERP large, gestion multi-sites. & Coût et complexité élevés pour une petite structure. & Justifie un périmètre modulaire. \\
L'Addition \cite{laddition} & Solution spécialisée restauration, caisse et service. & Couverture variable selon les offres et les intégrations. & Sert de repère pour les besoins terrain. \\
...
Cette comparaison montre que les solutions commerciales sont puissantes, mais qu'elles peuvent être coûteuses, fermées ou liées à un matériel précis. Tastify se place dans une logique pédagogique proche d'un mini-ERP métier : comprendre les flux d'un restaurant, les modéliser proprement et proposer une architecture réutilisable. Cette approche rejoint les principes des systèmes d'information intégrés, qui cherchent à centraliser les processus et les données d'une organisation \cite{davenport1998enterprise,monk2013erp}.
