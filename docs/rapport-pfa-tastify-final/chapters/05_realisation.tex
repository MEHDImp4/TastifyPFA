...
Les routes principales sont regroupées dans un routeur DRF. L'API backend expose notamment les ressources suivantes : catégories, plats, tables, plan-texts, commandes, lignes de commande, employés, shifts, offres, candidatures, réservations, avis, fidélité, récompenses, paramètres et paiements.
...
Sur la page d'accueil du portail client, les plats recommandés (issus de l'action \code{top-recommendations} de l'API) s'affichent sous la forme de suggestions, enrichies du premier avis positif du plat s'il existe.
...
\caption{Portail client : suggestions et plats recommandés avec avis positifs}
